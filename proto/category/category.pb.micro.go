...
type CategoryService interface {
	...
	FindCategoryByID(ctx context.Context, in *FindByIdRequest, opts ...client.CallOption) (*CategoryRequest, error)
...
func (c *categoryService) FindCategoryByID(ctx context.Context, in *FindByIdRequest, opts ...client.CallOption) (*CategoryRequest, error) {
...
type CategoryHandler interface {
	...
	FindCategoryByID(context.Context, *FindByIdRequest, *CategoryRequest) error
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		FindCategoryByID(ctx context.Context, in *FindByIdRequest, out *CategoryRequest) error
...
func (h *categoryHandler) FindCategoryByID(ctx context.Context, in *FindByIdRequest, out *CategoryRequest) error {
